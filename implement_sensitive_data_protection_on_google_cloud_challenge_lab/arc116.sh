...
echo "======================================================================"
echo "          Task 1. Redact sensitive data from text content"
echo "======================================================================"
...
echo "======================================================================"
echo "             Task 2. Create DLP inspection templates"
echo "======================================================================"
cat > struct_template.json << EOF 
{
  "deidentifyTemplate": {
    "deidentifyConfig": {
...
-H "Authorization: Bearer $ACCESS_TOKEN" \
-H "Content-Type: application/json" \
-d @unstruct_template.json \
"https://dlp.googleapis.com/v2/projects/$DEVSHELL_PROJECT_ID/locations/us/deidentifyTemplates"



echo "======================================================================"
echo "         Task 3. Configure a job trigger to run DLP inspection"
echo "======================================================================"
...
echo "Activating DLP job trigger..."
curl --request POST \
  -H "Content-Type: application/json" \
