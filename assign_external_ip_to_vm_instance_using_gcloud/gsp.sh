...
export IP_ADDRESS=$(gcloud compute addresses describe lab-static-ip --region=$REGION --format='get(address)')
gcloud compute instances add-access-config $VM_NAME --zone=$ZONE --address=$IP_ADDRESS
