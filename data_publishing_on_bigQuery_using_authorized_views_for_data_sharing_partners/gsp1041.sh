...
echo "======================================================================"
echo "      Task 4. Verify shared authorized views in customer projects"
echo "======================================================================"
echo "----------------------------------------------------------------------"
echo "             Verify authorized view sharing for Customer A"
echo "----------------------------------------------------------------------"
...
echo "----------------------------------------------------------------------"
echo "             Verify authorized view sharing for Customer B"
echo "----------------------------------------------------------------------"
